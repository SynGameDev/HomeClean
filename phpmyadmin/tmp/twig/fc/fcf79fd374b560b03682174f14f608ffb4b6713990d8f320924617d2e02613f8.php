...
class __TwigTemplate_ebe760589e3efe5cebd57dd5b51423c0a857b0ce1aa946d0d5a39d7dee818f3c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["text_dir"] ?? null), "form_name" => "dbStatsForm"]));
      ...
      ";
        ...
        ";
                ...
                // line 315
                echo "        ";
                $context["items"] = [0 => ["content" =>                 // line 316
($context["content"] ?? null), "class" => "li_switch_dbstats", "url" => ["href" => ("server_databases.php" . PhpMyAdmin\Url::getCommon(["statistics" => "1"])), "title" => _gettext("Enable statistics")]]];
                // line 323
                echo "        ";
                $this->loadTemplate("list/unordered.twig", "server/databases/index.twig", 323)->display(twig_to_array(["items" => ($context["items"] ?? null)]));
                // line 324
                echo "      ";
            }
            // line 325
